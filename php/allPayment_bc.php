				...
				while($exRes = mysqli_fetch_array($ex))
				{
					...
					{	
						if($cnt1>0)
						{
							...
							$msg	.= '<tr style="background:beige"><td colspan="2" style="text-align:right;border:0"></td><td>Total&nbsp;</td><td style="text-align:center;color:blue"><strong>'.$totalCash.'</strong></td></tr></table></div>';
						}//cnt1
					}// exe
					...
					if($exe)
					{
						...
						{	
							...
							$msg	.= '<tr style="background:beige"><td colspan="4" style="text-align:right;border:0"></td><td>Total&nbsp;</td><td style="text-align:center;color:blue"><strong>'.$totalCheque.'</strong></td></tr></table></div>';
						}//cnt2
					}// exe
					...
					if($exe)
					{
						...
						{	
							...
							$msg	.= '<tr style="background:beige"><td colspan="4" style="text-align:right;border:0"></td><td>Total&nbsp;</td><td style="text-align:center;color:blue"><strong>'.$totalNeft.'</strong></td></tr></table></div>';
						}//cnt2
					}// exe
